...
//  }
  ...
  def createPopulateRegionTable(usingOptionString: String, props: Map[String, String], sc: SparkContext, path: String, isSnappy: Boolean): Unit = {
    val snappyContext = SnappyContext.getOrCreate(sc)
...
//  def populateRegionTable(props: Map[String, String], sc: SparkContext, path:String): Unit = {
//    val snappyContext = SnappyContext.getOrCreate(sc)
//    val regionData = sc.textFile(s"$path/region.tbl")
//    val regionReadings = regionData.map(s => s.split('|')).map(s => parseRegionRow(s))
//    val regionDF = snappyContext.createDataFrame(regionReadings)
...
//  }
  ...
  def createPopulateNationTable(usingOptionString: String, props: Map[String, String], sc: SparkContext, path: String, isSnappy: Boolean): Unit = {
    val snappyContext = SnappyContext.getOrCreate(sc)
...
//  def populateNationTable(props: Map[String, String], sc: SparkContext, path:String): Unit = {
//    val snappyContext = SnappyContext.getOrCreate(sc)
//    val nationData = sc.textFile(s"$path/nation.tbl")
//    val nationReadings = nationData.map(s => s.split('|')).map(s => parseNationRow(s))
//    val nationDF = snappyContext.createDataFrame(nationReadings)
...
//  }
  ...
  def createPopulateSupplierTable(usingOptionString: String, props: Map[String, String], sc: SparkContext, path: String, isSnappy: Boolean): Unit = {
    val snappyContext = SnappyContext.getOrCreate(sc)
...
//  def populateSupplierTable(props: Map[String, String], sc: SparkContext, path:String): Unit = {
//    val snappyContext = SnappyContext.getOrCreate(sc)
//    val supplierData = sc.textFile(s"$path/supplier.tbl")
//    val supplierReadings = supplierData.map(s => s.split('|')).map(s => parseSupplierRow(s))
//    val supplierDF = snappyContext.createDataFrame(supplierReadings)
