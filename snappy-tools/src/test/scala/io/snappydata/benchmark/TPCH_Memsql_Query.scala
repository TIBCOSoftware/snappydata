...
//    execute("Q1", stmt) //RUN SUCCESSFULLY
//    execute("Q2", stmt) //RUN SUCCESSFULLY
//    execute("Q3", stmt) //RUN SUCCESSFULLY
//    execute("Q4", stmt) //RUN SUCCESSFULLY
//    execute("Q5", stmt) //RUN SUCCESSFULLY
//    execute("Q6", stmt) //RUN SUCCESSFULLY
//    execute("Q7", stmt) //RUN SUCCESSFULLY
//    execute("Q8", stmt) //RUN SUCCESSFULLY
//    execute("Q9", stmt) //RUN SUCCESSFULLY
//    execute("Q10", stmt) //RUN SUCCESSFULLY
//    execute("Q11", stmt) //RUN SUCCESSFULLY
//    execute("Q12", stmt) //RUN SUCCESSFULLY
//    execute("Q13", stmt) //check the manual that corresponds to your MySQL server version for the right syntax to use near '(C_CUSTKEY, c_count) group by         c_count order by         custdist desc,   ' at line 1
//    execute("Q14", stmt) //RUN SUCCESSFULLY
    ////execute("Q15", stmt)
//    execute("Q16", stmt) //RUN SUCCESSFULLY
//    execute("Q17", stmt)  //You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'key )' at line 1
//    execute("Q18", stmt) //RUN SUCCESSFULLY
//    execute("Q19", stmt) //You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ''
//    execute("Q20", stmt) //RUN SUCCESSFULLY
//    execute("Q21", stmt) //was taking time
    execute("Q22", stmt) //
    stmt.close();
  }


  def execute(queryNumber: String, stmt: Statement): Unit = {
    ...
    try {
      ...
      println(s"$queryNumber Executed")
