...
import io.snappydata.{TPCHColumnPartitionedTable, TPCHReplicatedTable, TPCHRowPartitionedTable, TPCH_Snappy_Query}
...
object Cluster_TPCH_Snappy {
  ...
  def main (args: Array[String]) {
    val conf = new SparkConf().setAppName("TPCH_Snappy")

    val urlString = "jdbc:snappydata:;locators=rdu-w27:10101;persist-dd=false;" +
        "member-timeout=600000;jmx-manager-start=false;enable-time-statistics=false;statistic-sampling-enabled=false"
