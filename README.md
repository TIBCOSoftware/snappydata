...
* [5 Minute QuickStart](featureDocs/quickstart.md)
...
## [Click here for Quick Start](featureDocs/quickstart.md)
...
Read SnappyData [docs](./featureDocs) for a more detailed list of all features and semantics. 
...
![ClusterArchitecture](featureDocs/GettingStarted_Architecture.png)

Details of about the architecture can be found here:

[Architecture](./featureDocs/architecture.md) 

SnappyData also has multiple deployment options which can be found here:

[Deployment Options](./featureDocs/deployment.md).
...
[Custom Configuration](./featureDocs/configuration.md)
...
<img src="featureDocs/ExternalBlockStoreSize.png" width="800">
...
Read our [docs](featureDocs) for details on the architecture.
...
Read our preliminary [row & column table docs](./featureDocs/rowAndColumnTables.md) for the details.
...
[Detailed AQP Documentation](./featureDocs/aqp.md)
...
[SnappyData's AQP Docs](./featureDocs/aqp.md)
