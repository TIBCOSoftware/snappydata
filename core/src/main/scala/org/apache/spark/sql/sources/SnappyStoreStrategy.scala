...
import org.apache.spark.sql.internal.{PutIntoColumnTable, SnappyInsertIntoTable}
 ...
 */
object SnappyStoreStrategy extends Strategy {
  def apply(plan: LogicalPlan): Seq[SparkPlan] = plan match {
    ...
    case SnappyInsertIntoTable(l@LogicalRelation(p: PlanInsertableRelation, _, _, _),
