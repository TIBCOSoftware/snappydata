...
//  /** Return a new SchemaDStream by applying a function to all elements of this SchemaDStream. */
//  def map[Row](mapFunc: Row => Row): SchemaDStream = {
//    new MappedSchemaDStream(this, context.sparkContext.clean(mapFunc))
//  }
