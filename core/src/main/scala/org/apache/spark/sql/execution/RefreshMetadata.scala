...
object RefreshMetadata extends Enumeration
  ...
  ADD_URIS_TO_CLASSLOADER, REMOVE_FUNCTION_JAR, REMOVE_URIS_FROM_CLASSLOADER, REMOVE_LOADER_WITH_REPL = Value
    ...
    action match {
      ...
      case REMOVE_URIS_FROM_CLASSLOADER =>
        ToolsCallbackInit.toolsCallback.removeURIsFromExecutorClassLoader(
          args.asInstanceOf[Array[String]])
      case REMOVE_LOADER_WITH_REPL =>
        ToolsCallbackInit.toolsCallback.invalidateReplClassLoader(
