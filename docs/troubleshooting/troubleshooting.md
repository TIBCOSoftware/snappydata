...
<question>
**Can I read orc files from snappy-shell ?**
</question>
<solution> 
...
<question>
Error message "IllegalArgumentException: System memory" is reported.
</question>
<solution> 
...
<question>Snappy shell unable to connect to server
Snappy shell unable to connect to server
when starting snappy-shell and executing the command to connect to the client, an error is reported. 
</question>
<solution> 
