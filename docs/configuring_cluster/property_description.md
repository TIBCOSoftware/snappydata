...
Also refer to [Configuration Parameters section](/reference/configuration_parameters/config_parameters.md#property-names).
...
## Approximate Query Processing (AQP) Properties
