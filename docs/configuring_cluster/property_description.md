...
|-J-Dgemfirexd.hostname-for-clients<a id="host-name"></a>|Hostname or IP address that is sent to clients so they can connect to the locator. The default is the `bind-address` of the locator.|Server|
