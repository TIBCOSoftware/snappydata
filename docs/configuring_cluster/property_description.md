...
|-log-file|Path of the file to which this member writes log messages (default is snappy[member].log in the working directory. For example, **snappyLocator.log**, **snappyLeader.log**,**snappyServer.log**)|Server</br>Lead</br>Locator|
