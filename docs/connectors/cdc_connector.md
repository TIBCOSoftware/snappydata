...
The following examples illustrates how you can write into a [SnappyData table](../programming_guide/building_snappydata_applications_using_spark_api.md#building-snappydata-applications-using-spark-api):
