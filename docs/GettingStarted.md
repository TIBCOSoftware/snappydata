...
* SnappyData Preview 0.1 download link [(tar.gz)](https://github.com/SnappyDataInc/snappydata/releases/download/v0.1.1-preview/snappydata-0.1.1-PREVIEW-bin.tar.gz) [(zip)](https://github.com/SnappyDataInc/snappydata/releases/download/v0.1.1-preview/snappydata-0.1.1-PREVIEW-bin.zip)
...
$ ./bin/snappy-job.sh submit --lead localhost:8090 --app-name airlineApp --class  io.snappydata.examples.CreateAndLoadAirlineDataJob --app-jar ./lib/quickstart-0.1.1-PREVIEW.jar
{"status": "STARTED",
  "result": {
...
$ ./bin/snappy-job.sh submit --lead localhost:8090 --app-name airlineApp  --class  io.snappydata.examples.AirlineDataJob --app-jar ./lib/quickstart-0.1.1-PREVIEW.jar
{ "status": "STARTED",
  "result": {
...
$ ./bin/snappy-job.sh submit --lead localhost:8090 --app-name TwitterPopularTagsJob --class io.snappydata.examples.TwitterPopularTagsJob --app-jar ./lib/quickstart-0.1.1-PREVIEW.jar --stream
