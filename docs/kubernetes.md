...
To find the IP address and port numbers of the locator or lead, use command `kubectl get svc --namespace=snappy`. The following sample output is displayed:<br>
...
```
In this sample output, three services namely *snappydata-leader-public*, *snappydata-locator-public* and 
...
*snappydata-leader-public* service exposes port **5050** for SnappyData Pulse and port **8090** to accept [SnappyData jobs](#jobkubernetes).
...
3.	Launch snappy shell  and connect to the *snappydata-locator-public* service's external IP address using the following commands:</br>
	`bin/snappy`</br>
	`externalURL:1527`</br>
