...
|**Batches Processed Status**| Total number of batches processed since streaming query has been started. Status can be **Active** or **Inactive**.</br>**Active**: Query is running</br> **Inactive**: Query is stopped or failed 
