...
4. Enable the SnappyData Zeppelin interpreter by adding `-zeppelin.interpreter.enable=true` in [lead node configuration](../configuring_cluster/configuration_files.md#configure-leads).
...
!!! Note
	You can modify the default port number of the Zeppelin intrepreter by setting the property
`-zeppelin.interpreter.port=<port_number>` in [lead node configuration](../configuring_cluster/configuration_files.md#configure-leads).
...
* [About the Interpreter](../concepts/isight/using_interpreter.md)

* [Example Notebooks](../concepts/isight/creating_notebooks.md)