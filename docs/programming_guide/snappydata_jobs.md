...
For Jobs, users need to include **[snappydata-cluster_2.11:1.0.0-rc1.1](http://mvnrepository.com/artifact/io.snappydata/snappydata-cluster_2.11/1.0.0-rc1.1)** to their project dependencies. In case the user project already includes dependency on Apache Spark and does not want to include snappy-spark dependencies, then, it is possible to explicitly exclude the snappy-spark dependencies.
