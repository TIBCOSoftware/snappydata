...
export APP_PROPS="dataLocation=$dataDir,Buckets_Order_Lineitem=$buckets_Order_Lineitem,Buckets_Cust_Part_PartSupp=$buckets_Cust_Part_PartSupp,useIndex=$UseIndex,Buckets_Cust_Part_PartSupp=$Buckets_Cust_Part_PartSupp,Buckets_Nation_Region_Supp=$Buckets_Nation_Region_Supp"
