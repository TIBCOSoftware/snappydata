...
scala -cp "$TPCHJar:/home/kishor/SNAPPY/COMMANDS/snappydata-client-1.5.5.jar" io.snappydata.benchmark.snappy.tpch.QueryExecutionJdbc $locator $port $queries $ResultCollection $WarmupRuns $AverageRuns $IsDynamic
