  ...
  def validateQueries(snc: SnappyContext, tableType: String, pw: PrintWriter): Unit = {
    for (q <- NWQueries.queries) {
      q._1 match {
        ...
        case "Q26_1" => assertJoin(snc, NWQueries.Q26_1, 54, "Q26_1", tableType, pw)
        case "Q26_2" => assertJoin(snc, NWQueries.Q26_2, 60, "Q26_2", tableType, pw)
        case "Q27" => assertJoin(snc, NWQueries.Q27, 9, "Q27", tableType, pw)
        case "Q27_1" => assertJoin(snc, NWQueries.Q27_1, 5, "Q27_1", tableType, pw)
        case "Q27_2" => assertJoin(snc, NWQueries.Q27_2, 8, "Q27_2", tableType, pw)
        case "Q27_3" => assertJoin(snc, NWQueries.Q27_3, 3, "Q27_3", tableType, pw)
        case "Q27_4" => assertJoin(snc, NWQueries.Q27_4, 6, "Q27_4", tableType, pw)
        case "Q28" => assertJoin(snc, NWQueries.Q28, 12, "Q28", tableType, pw)
        case "Q28_1" => assertJoin(snc, NWQueries.Q28_1, 12, "Q28_1", tableType, pw)
        case "Q28_2" => assertJoin(snc, NWQueries.Q28_2, 5, "Q28_2", tableType, pw)
        ...
        case "Q32_1" => assertJoin(snc, NWQueries.Q32_1, 282, "Q32_1", tableType, pw)
        case "Q33" => assertJoin(snc, NWQueries.Q33, 37, "Q33", tableType, pw)
        case "Q33_1" => assertJoin(snc, NWQueries.Q33_1, 769, "Q33_1", tableType, pw)
        case "Q34" => assertJoin(snc, NWQueries.Q34, 5, "Q34", tableType, pw)
        case "Q34_1" => assertJoin(snc, NWQueries.Q34_1, 1, "Q34_1", tableType, pw)
        case "Q34_2" => assertJoin(snc, NWQueries.Q34_2, 4, "Q34_2", tableType, pw)
        case "Q35" => assertJoin(snc, NWQueries.Q35, 3, "Q35", tableType, pw)
        case "Q35_1" => assertJoin(snc, NWQueries.Q35_1, 2, "Q35_1", tableType, pw)
        case "Q35_2" => assertJoin(snc, NWQueries.Q35_2, 3, "Q35_2", tableType, pw)
        case "Q36" => assertJoin(snc, NWQueries.Q36, 290, "Q36", tableType, pw)
        case "Q36_1" => assertJoin(snc, NWQueries.Q36_1, 232, "Q36_1", tableType, pw)
        case "Q36_2" => assertJoin(snc, NWQueries.Q36_2, 61, "Q36_2", tableType, pw)
        case "Q37" => assertJoin(snc, NWQueries.Q37, 77, "Q37", tableType, pw)
        case "Q38" => assertJoin(snc, NWQueries.Q38, 2155, "Q38", tableType, pw)
        case "Q38_1" => assertJoin(snc, NWQueries.Q38_1, 2080, "Q38_1", tableType, pw)
        case "Q38_2" => assertJoin(snc, NWQueries.Q38_2, 2041, "Q38_2", tableType, pw)
        case "Q39" => assertJoin(snc, NWQueries.Q39, 9, "Q39", tableType, pw)
        case "Q40" => assertJoin(snc, NWQueries.Q40, 830, "Q40", tableType, pw)
        case "Q40_1" => assertJoin(snc, NWQueries.Q40_1, 12, "Q40_1", tableType, pw)
        case "Q40_2" => assertJoin(snc, NWQueries.Q40_2, 9, "Q40_2", tableType, pw)
        ...
        case "Q43_1" => assertJoin(snc, NWQueries.Q43_1, 10, "Q43_1", tableType, pw)
        case "Q43_2" => assertJoin(snc, NWQueries.Q43_2, 2, "Q43_2", tableType, pw)
        ...
        case "Q49_1" => assertJoin(snc, NWQueries.Q49_1, 1713225, "Q49_1", tableType, pw)
        case "Q49_2" => assertJoin(snc, NWQueries.Q49_2, 1741240, "Q49_2", tableType, pw)
        case "Q50" => assertJoin(snc, NWQueries.Q50, 2155, "Q50", tableType, pw)
        case "Q51" => assertJoin(snc, NWQueries.Q51, 2155, "Q51", tableType, pw)
        case "Q51_1" => assertJoin(snc, NWQueries.Q51_1, 2080, "Q51_1", tableType, pw)
        case "Q51_2" => assertJoin(snc, NWQueries.Q51_2, 2041, "Q51_2", tableType, pw)
        ...
        case "Q55_1" => assertJoin(snc, NWQueries.Q55_1, 7, "Q55_1", tableType, pw)
        case "Q55_2" => assertJoin(snc, NWQueries.Q55_2, 6, "Q55_2", tableType, pw)
