...
class MapType extends SnappySQLJob{
  ...
  override def runSnappyJob(snappySession : SnappySession, jobConfig: Config): Any = {
    ...
    // SnappyTestUtils.assertQuery(snc, Map_Q1, "Map_Q1", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Map_Q2, "Map_Q2", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Map_Q3, "Map_Q3", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Map_Q4, "Map_Q4", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Map_Q5, "Map_Q5", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Map_Q6, "Map_Q6", pw, sqlContext)
