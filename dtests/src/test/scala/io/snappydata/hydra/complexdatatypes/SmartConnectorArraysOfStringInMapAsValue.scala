...
object SmartConnectorArraysOfStringInMapAsValue {
  def main(args: Array[String]): Unit = {
    ...
    SnappyTestUtils.assertQuery(snc, ComplexTypeUtils.Array_Map_Q1, "Array_Map_Q1",
      pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, ComplexTypeUtils.Array_Map_Q2, "Array_Map_Q2",
      pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, ComplexTypeUtils.Array_Map_Q3, "Array_Map_Q3",
      pw, sqlContext)
