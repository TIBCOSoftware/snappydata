...
class AllMixedTypes extends SnappySQLJob{
  ...
  override def runSnappyJob(snappySession: SnappySession, jobConfig: Config): Any = {
    ...
    SnappyTestUtils.assertQuery(snc, Mixed_Q2, "Mixed_Q2", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Mixed_Q3, "Mixed_Q3", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Mixed_Q4, "Mixed_Q4", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Mixed_Q5, "Mixed_Q5", pw, sqlContext)
