...
class ArrayType extends SnappySQLJob {
  ...
  override def runSnappyJob(snappySession: SnappySession, jobConfig: Config): Any = {
    ...
    SnappyTestUtils.assertQuery(snc, Array_Q1, "Array_Q1", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Array_Q2, "Array_Q2", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Array_Q3, "Array_Q3", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Array_Q4, "Array_Q4", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Array_Q5, "Array_Q5", pw, sqlContext)
