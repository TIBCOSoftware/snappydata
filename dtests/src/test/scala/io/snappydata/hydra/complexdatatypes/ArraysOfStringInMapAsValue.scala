...
class ArraysOfStringInMapAsValue extends SnappySQLJob{
  ...
  override def runSnappyJob(snappySession: SnappySession, jobConfig: Config): Any = {
    ...
    SnappyTestUtils.assertQuery(snc, Array_Map_Q1, "Array_Map_Q1", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Array_Map_Q2, "Array_Map_Q2", pw, sqlContext)
    SnappyTestUtils.assertQuery(snc, Array_Map_Q3, "Array_Map_Q3", pw, sqlContext)
