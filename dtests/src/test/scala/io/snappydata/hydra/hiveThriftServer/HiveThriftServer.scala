...
class HiveThriftServer extends SnappySQLJob {
  ...
  override def runSnappyJob(snappySession: SnappySession, jobConfig: Config): Any = {
    ...
    pw.println("-------------------------------------------------------------------------------")
    pw.println("Case 4 : Create column table from Snappy, insert,update,delete from beeline...")
    createRowOrColumnTableFromSnappy(snc,
    ...
    deleteFromTableFromBeeline(hiveThriftServer, "delete from Emp4",
    ...
    deleteFromTableFromBeeline(hiveThriftServer, "delete from Emp8",
