...
object CTQueries {
  ...
  val orders_details_create_ddl =
    "create table orders_details" +
        ...
        "LIMIT_PRICE DECIMAL(38, 18),STOP_PRICE DECIMAL(38, 18),ORDER_QTY DECIMAL(18, 4) ,TOTAL_EXECUTED_QTY DECIMAL(18, 4) ," +
        "AVG_PRICE DECIMAL(38, 18) ,DAY_EXECUTED_QTY DECIMAL(18, 4) ,DAY_AVG_PRICE DECIMAL(38, 18) ,REMNG_QTY DECIMAL(18, 4) ," +
        ...
        "EV DECIMAL(38, 18) ,SYS_DATA_MODIFIED_TS TIMESTAMP ,CMSN_TYPE VARCHAR(20) ,SYS_CREDIT_TRDR_ID VARCHAR(20) ,SYS_ENTRY_USER_ID VARCHAR(20) ," +
  ...
  val exec_details_create_ddl =
    "create table exec_details " +
        ...
        "TOTAL_EXECUTED_QTY DECIMAL(18, 4),AVG_PRICE DECIMAL( 38, 18),DEST_CD VARCHAR(20),CLIENT_ORDER_REFID VARCHAR(64)," +
        ...
        "DIGEST_KEY VARCHAR(128),TRUE_LAST_MKT VARCHAR(20),ENTRY_TS TIMESTAMP,OPT_STRIKE_PRICE DECIMAL( 38, 18)," +
        ...
        "DEST_ID_SRC VARCHAR(4),CONVER_RATIO DECIMAL(18, 9),STOCK_REF_PRICE DECIMAL( 38, 18),AS_OF_TRD_FG  VARCHAR(1)," +
