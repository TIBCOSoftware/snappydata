...
CREATE EXTERNAL TABLE staging_regions
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/regions.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_categories
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/categories.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_shippers
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/shippers.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_employees
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/employees.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_customers
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/customers.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_orders
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/orders.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_order_details
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/order-details.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_products
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/products.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_suppliers
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/suppliers.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_territories
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/territories.csv', header 'true');
...
CREATE EXTERNAL TABLE staging_employee_territories
    USING com.databricks.spark.csv OPTIONS(path ':dataLocation/employee-territories.csv', header 'true');
