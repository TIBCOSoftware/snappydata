...
-- CREATE PERSISTENT COLOCATED ROW TABLE ORDER_DETAILS --
...
CREATE TABLE ORDER_DETAILS
             ...
             USING row OPTIONS (partition_by 'SINGLE_ORDER_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy ':redundancy');

INSERT INTO ORDER_DETAILS SELECT * FROM staging_order_details;

-- DROP TABLE IF ALREADY EXISTS --
DROP TABLE IF EXISTS EXEC_DETAILS;
DROP TABLE IF EXISTS staging_exec_details;

-- CREATE PERSISTENT COLOCATED ROW TABLE EXEC_DETAILS --
...
CREATE TABLE EXEC_DETAILS
             (SELECT EXEC_DID BIGINT,SYS_EXEC_VER INTEGER,SYS_EXEC_ID VARCHAR(64),TRD_DATE VARCHAR(20),ALT_EXEC_ID VARCHAR(64),SYS_EXEC_STAT VARCHAR(20),
             ...
             UNDERLYING_FX_RATE DECIMAL(36, 8),CONVERSION_RATE DECIMAL(36, 8),TRANS_COMMENT VARCHAR(256),AGGRESSOR_FLAG VARCHAR(1))
              USING row OPTIONS (partition_by 'EXEC_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy ':redundancy',  COLOCATE_WITH 'ORDER_DETAILS');
