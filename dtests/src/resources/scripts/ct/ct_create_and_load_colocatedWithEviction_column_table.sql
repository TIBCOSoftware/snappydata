...
CREATE TABLE ORDER_DETAILS USING column OPTIONS (partition_by 'SINGLE_ORDER_DID', buckets '11', redundancy ':redundancy', EVICTION_BY ':evictionByOption') AS
...
CREATE TABLE EXEC_DETAILS USING column OPTIONS (partition_by 'EXEC_DID', buckets '11', redundancy ':redundancy', COLOCATE_WITH 'ORDER_DETAILS', EVICTION_BY ':evictionByOption') AS
