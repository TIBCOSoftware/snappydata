...
CREATE TABLE ORDER_DETAILS USING column OPTIONS (partition_by 'SINGLE_ORDER_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy '1') AS
...
CREATE TABLE EXEC_DETAILS USING column OPTIONS (partition_by 'EXEC_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy '1',  COLOCATE_WITH 'ORDER_DETAILS') AS
