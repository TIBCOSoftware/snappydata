...
CREATE TABLE ORDER_DETAILS USING column OPTIONS (partition_by 'SINGLE_ORDER_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy ':redundancy') AS
...
CREATE TABLE EXEC_DETAILS USING column OPTIONS (partition_by 'EXEC_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy ':redundancy',  COLOCATE_WITH 'ORDER_DETAILS') AS
