...
-- CREATE PERSISTENT COLOCATED COLUMN TABLE ORDERS_DETAILS --
...
CREATE TABLE EXEC_DETAILS
             ...
             USING column OPTIONS (partition_by 'EXEC_DID', buckets '11', PERSISTENT
             ':persistenceMode', redundancy ':redundancy',  COLOCATE_WITH 'ORDERS_DETAILS') ;
