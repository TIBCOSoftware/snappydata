...
CREATE TABLE ORDER_DETAILS USING row OPTIONS (partition_by 'SINGLE_ORDER_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy '1') AS
...
CREATE TABLE EXEC_DETAILS USING row OPTIONS (partition_by 'EXEC_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy '1') AS
