...
-- CREATE PERISTENT PARTITIONED ROW TABLE ORDER_DETAILS --
...
-- CREATE PERSISTENT PARTITIONED ROW TABLE EXEC_DETAILS --
...
CREATE TABLE EXEC_DETAILS
             ...
             USING row OPTIONS (partition_by 'EXEC_DID', buckets '11', PERSISTENT ':persistenceMode', redundancy ':redundancy');
