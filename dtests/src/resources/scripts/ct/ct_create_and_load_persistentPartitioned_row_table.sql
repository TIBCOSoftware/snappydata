...
CREATE TABLE ORDERS_DETAILS
             ...
             USING row OPTIONS (partition_by 'SINGLE_ORDER_DID', PERSISTENT ':persistenceMode', redundancy ':redundancy') ;
...
CREATE TABLE EXEC_DETAILS
             ...
             USING row OPTIONS (partition_by 'EXEC_DID', PERSISTENT ':persistenceMode', redundancy ':redundancy');
