...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_EVENT_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_STATUS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CLAIM_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CLAIM_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_DETAIL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CLAIM_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT_DETAIL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CLAIM_PAYMENT_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CLAIM_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CLAIM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_CONTACT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/ORGANIZATION_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMPLAINT_STATUS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/COMPLAINT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CONTACT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CLAIM_PAYMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TOPIC_COMMUNICATION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/TOPIC_COMMUNICATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CONTACT_TYPE_CONTACT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CONTACT_TYPE_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TOPIC
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/TOPIC.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LINE_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PROCEDURE_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PROCEDURE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CODE_VALUE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/CODE_VALUE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_POSTAL_ADDRESS
            USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/POSTAL_ADDRESS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSONS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GROUPS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/GROUPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMMUNICATION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/COMMUNICATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMPLAINT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/COMPLAINT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_INPATIENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_SERVICE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_SERVICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INQUIRY
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/INQUIRY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATIONS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/ORGANIZATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_REVIEW
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_REVIEW.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE_DETAIL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/INVOICE_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_DIAGNOSIS_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/DIAGNOSIS_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ELECTRONIC_ADDRESS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/ELECTRONIC_ADDRESS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ENTITY_BANK_ACCOUNT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/ENTITY_BANK_ACCOUNT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ETL_METADATA
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/ETL_METADATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/EXHIBIT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXPLANATION_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/EXPLANATION_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FILE_TRANSFER_RUN
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/FILE_TRANSFER_RUN.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FILE_TRANSFER_STAT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/FILE_TRANSFER_STAT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GENERAL_LEDGER
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/GENERAL_LEDGER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GROUP_RELATION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/GROUP_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LEP_APPEAL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LEP_APPEAL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LETTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_DISALLOW_EXPLANATION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LINE_DISALLOW_EXPLANATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_PROCEDURE_MODIFIER
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LINE_PROCEDURE_MODIFIER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MARX_CALENDAR
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/MARX_CALENDAR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_NOTE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/NOTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_CONTACT_TYPE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/ORGANIZATION_CONTACT_TYPE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PAYMENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PAYMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_COB
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_COB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_EVENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_LEP_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_PROFILE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_LEP_PROFILE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ORGANIZATION_RELATION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_ORGANIZATION_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_PAYMENT_OPTIONS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_PAYMENT_OPTIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_RELATION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ROLE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_ROLE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_SUBSIDY_PROFILE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_SUBSIDY_PROFILE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_WORK_ITEM
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_WORK_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PHONE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PHONE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PLAN_MEMBERSHIPS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PLAN_MEMBERSHIPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_POS_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/POS_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PREMIUM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_REFERENCE_DATA
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/REFERENCE_DATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_RETURNED_MAIL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/RETURNED_MAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_ACTIVITY
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_ACTIVITY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_DIAGNOSIS_LINE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_DIAGNOSIS_LINE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_DIAGNOSIS_SET
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_DIAGNOSIS_SET.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT_GROUP
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/EXHIBIT_GROUP.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT_GROUP_EXHIBIT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/EXHIBIT_GROUP_EXHIBIT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GENERAL_LEDGER_MAP
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/GENERAL_LEDGER_MAP.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LEP_APPEAL_DECISION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LEP_APPEAL_DECISION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_DETAIL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LETTER_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_JOB
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LETTER_JOB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_REGISTER
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LETTER_REGISTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_WORK_ITEM
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/LETTER_WORK_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_STATUS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_EVENT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_STATUS_REASON
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_EVENT_STATUS_REASON.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_PROFILE_RECORD
 USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_LEP_PROFILE_RECORD.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_CATEGORY
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PREMIUM_CATEGORY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_PART
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PREMIUM_PART.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_TABLE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PREMIUM_TABLE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_REVIEW
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_INPATIENT_REVIEW.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_STATUS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_INPATIENT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_SERVICE_OVERRIDE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_SERVICE_OVERRIDE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_STAY_LENGTH
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UM_INPATIENT_STAY_LENGTH.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_REVENUE_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/REVENUE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICE_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_EVENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/ORGANIZATION_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_TX_IDCARD
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/FDI_TX_IDCARD.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_TX_LETTER
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/FDI_TX_LETTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_CORRESPONDENCE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/FDI_CORRESPONDENCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/INVOICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE_STATUS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/INVOICE_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_BALANCE_EXCEPTIONS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/MOOP_BALANCE_EXCEPTIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_BALANCE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/MOOP_BALANCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_ACCUMULATOR
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/MOOP_ACCUMULATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ACCUMULATOR
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PERSON_ACCUMULATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PROCEDURE_PRICE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/PROCEDURE_PRICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_RECEIPT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/RECEIPT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_PLAN_CODE_CONFIG
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_PLAN_CODE_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_KEY_GENERATOR
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_KEY_GENERATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_GROUP_CODE_CONFIG
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_GROUP_CODE_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_DNIS_CONFIG
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_DNIS_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_DENIAL_REASON_CONFIG
      USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_DENIAL_REASON_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_CLIENT_MASTER
      USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_CLIENT_MASTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_SUBJECT_CATEGORY_TRANSLATIONS
     USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_SUBJECT_CATEGORY_TRANSLATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_PTMR_VARIABLE_TRANSLATIONS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_PTMR_VARIABLE_TRANSLATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_ACCOUNTING_CODES
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/SERVICES_ACCOUNTING_CODES.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UNAPPLIED_CASH
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/UNAPPLIED_CASH.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_WORK_GENERATED_KEYS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/USER2_Data_20G/WORK_GENERATED_KEYS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
