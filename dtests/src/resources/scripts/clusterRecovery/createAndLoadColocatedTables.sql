...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/BILLING_ENTITY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GROUPS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/GROUPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_PAYMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSONS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/PERSONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INQUIRY
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/INQUIRY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/ORGANIZATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_REVIEW
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_REVIEW.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_PACKAGE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/BENEFIT_PACKAGE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT_REDUCTION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_PAYMENT_REDUCTION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/PERSON_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BANK
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/BANK.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/INVOICE_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/PERSON_EVENT_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSON_EVENT_ATTRIBUTE USING column OPTIONS(partition_by 'PRSN_EVNT_ID', buckets '32',redundancy '1',colocate_with 'PERSON_EVENT', 'CLIENT_ID,PRSN_EVNT_ID,PRSN_EVNT_ATTR_ID ' ) AS (SELECT * FROM staging_PERSON_EVENT_ATTRIBUTE);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_STATUS USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,SEQ_NUM,CLM_STAT_ID ' ) AS (SELECT * FROM staging_CLAIM_STATUS);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_ADDITIONAL_DIAGNOSIS USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_ADD_DIAG_ID ' ) AS (SELECT * FROM staging_CLAIM_ADDITIONAL_DIAGNOSIS);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_DETAIL USING column OPTIONS(partition_by 'PRSN_ID', buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,SEQ_NUM,CLM_DTL_ID ' ) AS (SELECT * FROM staging_CLAIM_DETAIL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_PAYMENT_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_PAYMENT_DETAIL USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_PAY_ID,CLM_PAY_DTL_ID ' ) AS (SELECT * FROM staging_CLAIM_PAYMENT_DETAIL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_ATTRIBUTE USING column OPTIONS(partition_by 'PRSN_ID', buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_ATTR_ID ' ) AS (SELECT * FROM staging_CLAIM_ATTRIBUTE);

DROP TABLE IF EXISTS CLAIM;
DROP TABLE IF EXISTS staging_CLAIM;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM USING column OPTIONS(partition_by 'PRSN_ID', buckets '32',colocate_with 'PERSONS',redundancy '1',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID ' ) AS (SELECT * FROM staging_CLAIM);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/PERSON_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSON_CONTACT USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CNTC_ID,PRSN_CNTC_ID ' ) AS (SELECT * FROM staging_PERSON_CONTACT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/ORGANIZATION_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ORGANIZATION_CODE USING column OPTIONS(partition_by 'ORG_ID', buckets '32',colocate_with 'ORGANIZATIONS',redundancy '1',key_columns 'CLIENT_ID,ORG_ID,CD_VAL_ID,ORG_CD_ID ' ) AS (SELECT * FROM staging_ORGANIZATION_CODE);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMPLAINT_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/COMPLAINT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COMPLAINT_STATUS USING column OPTIONS(partition_by 'INQ_ID',buckets '32',redundancy '1',colocate_with 'INQUIRY',key_columns 'CLIENT_ID,INQ_ID,COMPLAINT_ID,COMPLAINT_STAT_ID ' ) AS (SELECT * FROM staging_COMPLAINT_STATUS);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TOPIC_COMMUNICATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/TOPIC_COMMUNICATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CONTACT_TYPE_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CONTACT_TYPE_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CONTACT_TYPE_CONTACT USING column OPTIONS(partition_by 'CNTC_ID', buckets '32',redundancy '1',colocate_with 'CONTACT',key_columns 'CLIENT_ID,CNTC_ID,ORG_CNTC_TYP_ID,CNTC_TYP_CNTC_ID ' ) AS (SELECT * FROM staging_CONTACT_TYPE_CONTACT);

DROP TABLE IF EXISTS TOPIC;
DROP TABLE IF EXISTS staging_TOPIC;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TOPIC
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/TOPIC.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS TOPIC USING column OPTIONS(partition_by 'INQ_ID',buckets '32',redundancy '1',colocate_with 'INQUIRY',key_columns 'CLIENT_ID,INQ_ID,TPC_ID ' ) AS (SELECT * FROM staging_TOPIC);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/LINE_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS LINE_ADDITIONAL_DIAGNOSIS USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',colocate_with 'PERSONS',redundancy '1',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,SEQ_NUM,CLM_ADD_DIAG_ID,LN_ADD_DIAG_ID ' ) AS (SELECT * FROM staging_LINE_ADDITIONAL_DIAGNOSIS);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PROCEDURE_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/PROCEDURE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CODE_VALUE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CODE_VALUE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_POSTAL_ADDRESS
            USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/POSTAL_ADDRESS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS POSTAL_ADDRESS USING column OPTIONS(partition_by 'CNTC_ID',redundancy '1',colocate_with 'CONTACT',key_columns 'CLIENT_ID,CNTC_ID,PSTL_ADDR_ID') AS (SELECT * FROM staging_POSTAL_ADDRESS);

DROP TABLE IF EXISTS CLIENTS;
DROP TABLE IF EXISTS staging_CLIENTS;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLIENTS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLIENTS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMMUNICATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/COMMUNICATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COMMUNICATION USING column OPTIONS(partition_by 'INQ_ID', buckets '32',colocate_with 'INQUIRY',redundancy '1',key_columns ' CLIENT_ID,INQ_ID,CMCN_ID' ) AS (SELECT * FROM staging_COMMUNICATION);

DROP TABLE IF EXISTS COMPLAINT;
DROP TABLE IF EXISTS staging_COMPLAINT;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMPLAINT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/COMPLAINT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COMPLAINT USING column OPTIONS(partition_by 'INQ_ID',buckets '32',colocate_with 'INQUIRY',redundancy '1',key_columns 'CLIENT_ID,INQ_ID,COMPLAINT_ID ' ) AS (SELECT * FROM staging_COMPLAINT);

DROP TABLE IF EXISTS ADJUSTMENT;
DROP TABLE IF EXISTS staging_ADJUSTMENT;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ADJUSTMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/ADJUSTMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ADJUSTMENT USING column OPTIONS(partition_by 'BILL_ENT_ID',buckets '32',colocate_with 'BILLING_ENTITY',redundancy '1',key_columns 'CLIENT_ID,BILL_ENT_ID,ADJ_ID ' ) AS (SELECT * FROM staging_ADJUSTMENT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_REDUCTION_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_REDUCTION_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_REDUCTION_DETAIL USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_PAY_RDCTN_ID,CLM_RDCTN_DTL_ID ' ) AS (SELECT * FROM staging_CLAIM_REDUCTION_DETAIL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_REDUCTION_HISTORY
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_REDUCTION_HISTORY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_REDUCTION_HISTORY USING column OPTIONS(partition_by 'CLM_PAY_RDCTN_ID', buckets '32',redundancy '1',colocate_with 'CLAIM_PAYMENT_REDUCTION',key_columns 'CLIENT_ID,CLM_PAY_RDCTN_ID,CLM_RDCTN_HIST_ID ' ) AS (SELECT * FROM staging_CLAIM_REDUCTION_HISTORY);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_COB
      USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_COB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
  CREATE TABLE IF NOT EXISTS CLAIM_COB USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_COB_ID ' ) AS (SELECT * FROM staging_CLAIM_COB);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_HOSPITAL
      USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/CLAIM_HOSPITAL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
  CREATE TABLE IF NOT EXISTS CLAIM_HOSPITAL USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1',colocate_with 'PERSONS',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_HOSP_ID ' ) AS (SELECT * FROM staging_CLAIM_HOSPITAL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/UM_INPATIENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS UM_INPATIENT USING column OPTIONS(partition_by 'UM_RVW_ID',buckets '32',redundancy '1',colocate_with 'UM_REVIEW',key_columns 'CLIENT_ID,UM_RVW_ID,UM_INPT_ID ' ) AS (SELECT * FROM staging_UM_INPATIENT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_SERVICE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationCol/UM_SERVICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_GROUP_NAME
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BENEFIT_GROUP_NAME.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BENEFIT_GROUP_NAME(
 ...
 USING row OPTIONS(partition_by 'GRP_ID', buckets '32',colocate_with 'GROUPS',redundancy '1',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_GROUPS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BENEFIT_GROUPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_RECONCILIATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BILLING_RECONCILIATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BILLING_RECONCILIATION(
 ...
 USING row OPTIONS(partition_by 'BILL_ENT_ID', buckets '32',colocate_with 'BILLING_ENTITY',redundancy '1',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CHECKS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/CHECKS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CHECKS(
 ...
 USING row OPTIONS(partition_by 'CLM_PAY_ID', buckets '32',colocate_with 'CLAIM_PAYMENT',redundancy '1',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLIENT_REFERENCE_DATA
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/CLIENT_REFERENCE_DATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COB_CLAIM_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/COB_CLAIM_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COB_CLAIM_DIAGNOSIS(
 ...
 USING row OPTIONS(partition_by 'PRSN_ID',buckets '32',colocate_with 'PERSONS',redundancy '1',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COB_ORGANIZATION_PERSON
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/COB_ORGANIZATION_PERSON.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_DIAGNOSIS_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/DIAGNOSIS_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ELECTRONIC_ADDRESS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/ELECTRONIC_ADDRESS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ELECTRONIC_ADDRESS(
 ...
 USING row OPTIONS(partition_by 'CNTC_ID',buckets '32',redundancy '1',colocate_with 'CONTACT',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ENTITY_BANK_ACCOUNT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/ENTITY_BANK_ACCOUNT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ENTITY_BANK_ACCOUNT(
  ...
  ) USING row OPTIONS(partition_by 'BILL_ENT_ID', buckets '32',redundancy '1',colocate_with 'BILLING_ENTITY',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ETL_METADATA
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/ETL_METADATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/EXHIBIT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXPLANATION_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/EXPLANATION_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FILE_TRANSFER_RUN
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/FILE_TRANSFER_RUN.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FILE_TRANSFER_STAT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/FILE_TRANSFER_STAT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GENERAL_LEDGER
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/GENERAL_LEDGER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GROUP_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/GROUP_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS GROUP_RELATION(
  ...
  ) USING row OPTIONS(partition_by 'GRP_ID',buckets '32',redundancy '1',colocate_with 'GROUPS',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LEP_APPEAL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LEP_APPEAL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS LEP_APPEAL(
  ...
  ) USING row OPTIONS(partition_by 'PRSN_ID', buckets '32',redundancy '1',colocate_with 'PERSONS',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LETTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_DISALLOW_EXPLANATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LINE_DISALLOW_EXPLANATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_PROCEDURE_MODIFIER
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LINE_PROCEDURE_MODIFIER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MARX_CALENDAR
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/MARX_CALENDAR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_NOTE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/NOTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS NOTE(
  ...
  ) USING row OPTIONS(partition_by 'INQ_ID',buckets '32',redundancy '1',colocate_with 'INQUIRY',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_CONTACT_TYPE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/ORGANIZATION_CONTACT_TYPE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ORGANIZATION_CONTACT_TYPE(
  ...
  ) USING row OPTIONS(partition_by 'ORG_ID', buckets '32',redundancy '1',colocate_with 'ORGANIZATIONS',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PAYMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PAYMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_COB
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_COB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_EVENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_LEP_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_PROFILE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_LEP_PROFILE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ORGANIZATION_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_ORGANIZATION_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_PAYMENT_OPTIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_PAYMENT_OPTIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ROLE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_ROLE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_SUBSIDY_PROFILE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_SUBSIDY_PROFILE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_WORK_ITEM
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_WORK_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PHONE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PHONE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PLAN_MEMBERSHIPS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PLAN_MEMBERSHIPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_POS_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/POS_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PREMIUM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_REFERENCE_DATA
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/REFERENCE_DATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_RETURNED_MAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/RETURNED_MAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_ACTIVITY
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_ACTIVITY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS UM_ACTIVITY(
  ...
  ) USING row OPTIONS(partition_by 'UM_RVW_ID', buckets '32',redundancy '1',colocate_with 'UM_REVIEW',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_DIAGNOSIS_LINE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_DIAGNOSIS_LINE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_DIAGNOSIS_SET
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_DIAGNOSIS_SET.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_PACKAGE_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BENEFIT_PACKAGE_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BENEFIT_PACKAGE_RELATION(
  ...
  ) USING row OPTIONS(partition_by 'BENE_PKG_ID', buckets '32',redundancy '1',colocate_with 'BENEFIT_PACKAGE',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BILLING_ENTITY_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BILLING_ENTITY_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CHECK_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/CHECK_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CHECK_STATUS(
  ...
  ) USING row OPTIONS(partition_by 'CLM_PAY_ID',buckets '32',redundancy '1',colocate_with 'CLAIM_PAYMENT',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT_GROUP
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/EXHIBIT_GROUP.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT_GROUP_EXHIBIT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/EXHIBIT_GROUP_EXHIBIT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GENERAL_LEDGER_MAP
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/GENERAL_LEDGER_MAP.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LEP_APPEAL_DECISION
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LEP_APPEAL_DECISION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LETTER_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_JOB
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LETTER_JOB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_REGISTER
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LETTER_REGISTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_WORK_ITEM
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/LETTER_WORK_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_EVENT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSON_EVENT_STATUS(
  ...
  ) USING row OPTIONS(partition_by 'PRSN_EVNT_ID', buckets '32',redundancy '1',colocate_with 'PERSON_EVENT',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_STATUS_REASON
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_EVENT_STATUS_REASON.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_PROFILE_RECORD
 USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_LEP_PROFILE_RECORD.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_CATEGORY
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PREMIUM_CATEGORY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_PART
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PREMIUM_PART.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_TABLE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PREMIUM_TABLE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_REVIEW
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_INPATIENT_REVIEW.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_INPATIENT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_SERVICE_OVERRIDE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_SERVICE_OVERRIDE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BANK_ACCOUNT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BANK_ACCOUNT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BANK_ACCOUNT(
  ...
  ) USING row OPTIONS(partition_by 'BNK_ORG_ID',buckets '32',redundancy '1',colocate_with 'BANK',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true' );
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_STAY_LENGTH
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UM_INPATIENT_STAY_LENGTH.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_REVENUE_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/REVENUE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICE_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/SERVICE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_AGREEMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/AGREEMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_EVENT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/ORGANIZATION_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ORGANIZATION_EVENT(
  ...
  ) USING row OPTIONS(partition_by 'ORG_ID', buckets '32',redundancy '1',colocate_with 'ORAGANIZATIONS',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_TX_IDCARD
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/FDI_TX_IDCARD.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_TX_LETTER
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/FDI_TX_LETTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_PACKAGE_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BENEFIT_PACKAGE_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY_SCHEDULE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BILLING_ENTITY_SCHEDULE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_SCHEDULE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BILLING_SCHEDULE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_SOURCE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/BILLING_SOURCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CHARGE_ITEM
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/CHARGE_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_COSHARE_TRACKING
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/CLAIM_COSHARE_TRACKING.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_LINE_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/CLAIM_LINE_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_CORRESPONDENCE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/FDI_CORRESPONDENCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/INVOICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/INVOICE_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  INVOICE_STATUS(
  ...
  ) USING row OPTIONS(partition_by 'INV_ID',buckets '32',redundancy '1',colocate_with 'INVOICE_DETAIL',EVICTION_BY 'LRUHEAPPERCENT', overflow 'true');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_BALANCE_EXCEPTIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/MOOP_BALANCE_EXCEPTIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_BALANCE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/MOOP_BALANCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_ACCUMULATOR
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/MOOP_ACCUMULATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ACCUMULATOR
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PERSON_ACCUMULATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PROCEDURE_PRICE
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/PROCEDURE_PRICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_RECEIPT
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/RECEIPT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_PLAN_CODE_CONFIG
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_PLAN_CODE_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_KEY_GENERATOR
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_KEY_GENERATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_GROUP_CODE_CONFIG
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_GROUP_CODE_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_DNIS_CONFIG
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_DNIS_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_DENIAL_REASON_CONFIG
      USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_DENIAL_REASON_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_CLIENT_MASTER
      USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_CLIENT_MASTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_SUBJECT_CATEGORY_TRANSLATIONS
     USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_SUBJECT_CATEGORY_TRANSLATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_PTMR_VARIABLE_TRANSLATIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_PTMR_VARIABLE_TRANSLATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TMGSERVICES_ACCOUNTING_CODES
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/TMGSERVICES_ACCOUNTING_CODES.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UNAPPLIED_CASH
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/UNAPPLIED_CASH.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_WORK_GENERATED_KEYS
    USING com.databricks.spark.csv OPTIONS (path ':dataLocationRow/WORK_GENERATED_KEYS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  WORK_GENERATED_KEYS(
      ...
      GEN_KEY_PAD VARCHAR(12) DEFAULT '0',
      GEN_KEY_STRING VARCHAR(12),
      GEN_KEY_RESET_VALUE INT DEFAULT 1,
      VER BIGINT NOT NULL,
      VLD_FRM_DT date NOT NULL,
      VLD_TO_DT date,
