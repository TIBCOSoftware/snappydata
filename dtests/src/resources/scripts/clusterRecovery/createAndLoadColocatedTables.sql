...
CREATE TABLE IF NOT EXISTS INQUIRY(  INQ_ID INTEGER  NOT NULL,
                       VER BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ORGANIZATIONS(ORG_ID INTEGER NOT NULL,
                             VER BIGINT NOT NULL,
                             CLIENT_ID BIGINT NOT NULL,
                             ORG_NM VARCHAR(8),
...
CREATE TABLE IF NOT EXISTS UM_REVIEW(UM_RVW_ID INTEGER  NOT NULL,
                         VER BIGINT NOT NULL,
                         CLIENT_ID BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS PERSON_EVENT_ATTRIBUTE USING column OPTIONS(partition_by 'PRSN_EVNT_ID', buckets '32',redundancy '1',colocate_with 'PERSON_EVENT',key_columns 'CLIENT_ID,PRSN_EVNT_ID,PRSN_EVNT_ATTR_ID ' ) AS (SELECT * FROM staging_PERSON_EVENT_ATTRIBUTE);
...
CREATE TABLE IF NOT EXISTS POSTAL_ADDRESS USING column OPTIONS(partition_by 'CNTC_ID',redundancy '1',buckets '32',colocate_with 'CONTACT',key_columns 'CLIENT_ID,CNTC_ID,PSTL_ADDR_ID') AS (SELECT * FROM staging_POSTAL_ADDRESS);
...
CREATE TABLE IF NOT EXISTS BILLING_RECONCILIATION(
  BILL_ENT_ID INTEGER NOT NULL,
  BILL_RECON_ID INTEGER   NOT NULL,
  VER BIGINT NOT NULL,
  CLIENT_ID BIGINT NOT NULL,
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT_GROUP
    USING com.databricks.spark.csv OPTIONS (path ':dataLocation/EXHIBIT_GROUP.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE TABLE IF NOT EXISTS FDI_TX_IDCARD
  ...
  ORG_ID BIGINT NOT NULL,
  ORG_DESC VARCHAR(15),
  FLRQ_PREPRINT_DCN VARCHAR(50),
  FLRQ_POSTPRINT_DCN VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS  SERVICES_KEY_GENERATOR
  ...
  VER   BIGINT  NOT NULL,
  CLIENT_ID BIGINT  NOT NULL,
  KEY_GEN_FORMAT   VARCHAR(50)    NULL,
...
CREATE TABLE IF NOT EXISTS SERVICES_CLIENT_MASTER
  ...
  VER  BIGINT NOT NULL,
  CLIENT_ID  BIGINT NOT NULL,
  CLIENT_LEGACY_CD    VARCHAR(50)    NULL,
