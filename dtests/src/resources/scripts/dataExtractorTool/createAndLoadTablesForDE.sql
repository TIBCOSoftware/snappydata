...
CREATE TABLE IF NOT EXISTS StudentMarksRecord (rollno Integer, name String,Maths MAP<STRING,DOUBLE>,Science MAP<STRING,DOUBLE>, English MAP<STRING,DOUBLE>, Computer MAP<STRING,DOUBLE>, Music MAP<STRING,Double>, History MAP<STRING,DOUBLE>) USING column;
...
CREATE TABLE IF NOT EXISTS TwentyTwenty(name String,LastThreeMatchPerformance ARRAY<Double>,Roll MAP<SMALLINT,STRING>,Profile STRUCT<Matches:Long,Runs:Int,SR:Double,isPlaying:Boolean>) USING column;
...
CREATE TABLE IF NOT EXISTS TwoWheeler (brand String,BikeInfo ARRAY< STRUCT <type:String,cc:Double,noofgears:BigInt,instock:Boolean>>) USING column;
...
CREATE TABLE IF NOT EXISTS FamousPeople(country String,celebrities MAP<String,Array<String>>) USING column;
...
CREATE TABLE ORDERS_DETAILS
             ...
             USING column OPTIONS (partition_by 'SINGLE_ORDER_DID', redundancy '1');
...
CREATE TABLE EXEC_DETAILS(
             ...
             USING column OPTIONS (partition_by 'EXEC_DID', redundancy '1');
