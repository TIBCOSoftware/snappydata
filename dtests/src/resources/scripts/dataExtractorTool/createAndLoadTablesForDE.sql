...
CREATE EXTERNAL TABLE staging_orders_details USING com.databricks.spark.csv  OPTIONS (path '/home/supriya/Downloads/ORDERS_DETAILS.dat', header 'true', inferSchema 'false',nullValue 'NULL', maxCharsPerColumn '4096');
