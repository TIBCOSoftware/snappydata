CREATE EXTERNAL TABLE staging_PERSON_EVENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/PERSON_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_PERSON_EVENT_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/PERSON_EVENT_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CLAIM_STATUS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CLAIM_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CLAIM_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CLAIM_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CLAIM_DETAIL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CLAIM_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CLAIM_PAYMENT_DETAIL
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CLAIM_PAYMENT_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE CLAIM_PAYMENT_DETAIL USING column OPTIONS(partition_by 'PRSN_ID',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_PAY_ID,CLM_PAY_DTL_ID ') AS (SELECT * FROM staging_CLAIM_PAYMENT_DETAIL);
  ...
  CREATE EXTERNAL TABLE staging_CLAIM_ATTRIBUTE
      USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CLAIM_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CLAIM
  USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CLAIM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_PERSON_CONTACT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/PERSON_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_ORGANIZATION_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/ORGANIZATION_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_COMPLAINT_STATUS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/COMPLAINT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CONTACT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CLAIM_PAYMENT
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CLAIM_PAYMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_TOPIC_COMMUNICATION
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/TOPIC_COMMUNICATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CONTACT_TYPE_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_TOPIC
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/TOPIC.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_LINE_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/LINE_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_PROCEDURE_CODE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/PROCEDURE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_CODE_VALUE
    USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/CODE_VALUE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE staging_POSTAL_ADDRESS
            USING com.databricks.spark.csv OPTIONS (path '/export/shared/QA_DATA/TMG_Data/DataGenerator/POSTAL_ADDRESS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
