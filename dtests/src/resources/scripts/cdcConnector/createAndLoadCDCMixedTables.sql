...
CREATE TABLE IF NOT EXISTS PERSON_EVENT USING column OPTIONS(partition_by 'PRSN_EVNT_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_EVNT_ID ' ) AS (SELECT * FROM staging_PERSON_EVENT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/PERSON_EVENT_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSON_EVENT_ATTRIBUTE USING column OPTIONS(partition_by 'PRSN_EVNT_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,PRSN_EVNT_ID,PRSN_EVNT_ATTR_ID ' ) AS (SELECT * FROM staging_PERSON_EVENT_ATTRIBUTE);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_STATUS USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,SEQ_NUM,CLM_STAT_ID ' ) AS (SELECT * FROM staging_CLAIM_STATUS);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_ADDITIONAL_DIAGNOSIS USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_ADD_DIAG_ID ' ) AS (SELECT * FROM staging_CLAIM_ADDITIONAL_DIAGNOSIS);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_DETAIL USING column OPTIONS(partition_by 'PRSN_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,SEQ_NUM,CLM_DTL_ID ' ) AS (SELECT * FROM staging_CLAIM_DETAIL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_PAYMENT_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_PAYMENT_DETAIL USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_PAY_ID,CLM_PAY_DTL_ID ' ) AS (SELECT * FROM staging_CLAIM_PAYMENT_DETAIL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_ATTRIBUTE USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_ATTR_ID ' ) AS (SELECT * FROM staging_CLAIM_ATTRIBUTE);

DROP TABLE IF EXISTS CLAIM;
DROP TABLE IF EXISTS staging_CLAIM;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID ' ) AS (SELECT * FROM staging_CLAIM);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/PERSON_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSON_CONTACT USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CNTC_ID,PRSN_CNTC_ID ' ) AS (SELECT * FROM staging_PERSON_CONTACT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/ORGANIZATION_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ORGANIZATION_CODE USING column OPTIONS(partition_by 'ORG_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID,ORG_ID,CD_VAL_ID,ORG_CD_ID ' ) AS (SELECT * FROM staging_ORGANIZATION_CODE);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMPLAINT_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/COMPLAINT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COMPLAINT_STATUS USING column OPTIONS(partition_by 'INQ_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,INQ_ID,COMPLAINT_ID,COMPLAINT_STAT_ID ' ) AS (SELECT * FROM staging_COMPLAINT_STATUS);

DROP TABLE IF EXISTS CONTACT;
DROP TABLE IF EXISTS staging_CONTACT;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CONTACT USING column OPTIONS(partition_by 'CNTC_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,CNTC_ID' ) AS (SELECT * FROM staging_CONTACT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_PAYMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_PAYMENT USING column OPTIONS(partition_by 'CLM_PAY_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,CLM_PAY_ID ' ) AS (SELECT * FROM staging_CLAIM_PAYMENT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TOPIC_COMMUNICATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/TOPIC_COMMUNICATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS TOPIC_COMMUNICATION USING column OPTIONS(partition_by 'CMCN_INQ_ID',redundancy '1', buckets '32',key_columns ' CLIENT_ID,CMCN_INQ_ID,TPC_INQ_ID,CMCN_ID,TPC_ID' ) AS (SELECT * FROM staging_TOPIC_COMMUNICATION);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CONTACT_TYPE_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CONTACT_TYPE_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CONTACT_TYPE_CONTACT USING column OPTIONS(partition_by 'CNTC_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,CNTC_ID,ORG_CNTC_TYP_ID,CNTC_TYP_CNTC_ID ' ) AS (SELECT * FROM staging_CONTACT_TYPE_CONTACT);

DROP TABLE IF EXISTS TOPIC;
DROP TABLE IF EXISTS staging_TOPIC;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_TOPIC
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/TOPIC.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_ADDITIONAL_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/LINE_ADDITIONAL_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS LINE_ADDITIONAL_DIAGNOSIS USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,SEQ_NUM,CLM_ADD_DIAG_ID,LN_ADD_DIAG_ID ' ) AS (SELECT * FROM staging_LINE_ADDITIONAL_DIAGNOSIS);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PROCEDURE_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/PROCEDURE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PROCEDURE_CODE USING column OPTIONS(partition_by 'PR_CD_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID,PR_CD_ID ' ) AS (SELECT * FROM staging_PROCEDURE_CODE);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CODE_VALUE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CODE_VALUE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CODE_VALUE USING column OPTIONS(partition_by 'CD_VAL_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID,CD_VAL_ID') AS (SELECT * FROM staging_CODE_VALUE);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_POSTAL_ADDRESS
            USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/POSTAL_ADDRESS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLIENTS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLIENTS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLIENTS USING column OPTIONS(partition_by 'CLIENT_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID ' ) AS (SELECT * FROM staging_CLIENTS);

DROP TABLE IF EXISTS PERSONS;
DROP TABLE IF EXISTS staging_PERSONS;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSONS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/PERSONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSONS USING column OPTIONS(partition_by 'PRSN_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID ' ) AS (SELECT * FROM staging_PERSONS);

DROP TABLE IF EXISTS BANK;
DROP TABLE IF EXISTS staging_BANK;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BANK
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/BANK.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BANK USING column OPTIONS(partition_by 'BNK_ORG_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,BNK_ORG_ID,BNK_ID ' ) AS (SELECT * FROM staging_BANK);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/BILLING_ENTITY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BILLING_ENTITY USING column OPTIONS(partition_by 'BILL_ENT_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,BILL_ENT_ID') AS (SELECT * FROM staging_BILLING_ENTITY);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_PACKAGE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/BENEFIT_PACKAGE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GROUPS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/GROUPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS GROUPS USING column OPTIONS(partition_by 'GRP_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,GRP_ID' ) AS (SELECT * FROM staging_GROUPS);

DROP TABLE IF EXISTS COMMUNICATION;
DROP TABLE IF EXISTS staging_COMMUNICATION;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMMUNICATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/COMMUNICATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COMMUNICATION USING column OPTIONS(partition_by 'INQ_ID',redundancy '1', buckets '32',key_columns ' CLIENT_ID,INQ_ID,CMCN_ID' ) AS (SELECT * FROM staging_COMMUNICATION);

DROP TABLE IF EXISTS COMPLAINT;
DROP TABLE IF EXISTS staging_COMPLAINT;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COMPLAINT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/COMPLAINT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COMPLAINT USING column OPTIONS(partition_by 'INQ_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,INQ_ID,COMPLAINT_ID ' ) AS (SELECT * FROM staging_COMPLAINT);

DROP TABLE IF EXISTS ADJUSTMENT;
DROP TABLE IF EXISTS staging_ADJUSTMENT;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ADJUSTMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/ADJUSTMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ADJUSTMENT USING column OPTIONS(partition_by 'BILL_ENT_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,BILL_ENT_ID,ADJ_ID ' ) AS (SELECT * FROM staging_ADJUSTMENT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_PAYMENT_REDUCTION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_PAYMENT_REDUCTION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_PAYMENT_REDUCTION USING column OPTIONS(partition_by 'CLM_PAY_RDCTN_ID',redundancy '1', buckets '32',key_columns 'CLIENT_ID,CLM_PAY_RDCTN_ID ' ) AS (SELECT * FROM staging_CLAIM_PAYMENT_REDUCTION);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_REDUCTION_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_REDUCTION_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_REDUCTION_DETAIL USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_PAY_RDCTN_ID,CLM_RDCTN_DTL_ID ' ) AS (SELECT * FROM staging_CLAIM_REDUCTION_DETAIL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_REDUCTION_HISTORY
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_REDUCTION_HISTORY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLAIM_REDUCTION_HISTORY USING column OPTIONS(partition_by 'CLM_PAY_RDCTN_ID', redundancy '1',buckets '32',key_columns 'CLIENT_ID,CLM_PAY_RDCTN_ID,CLM_RDCTN_HIST_ID ' ) AS (SELECT * FROM staging_CLAIM_REDUCTION_HISTORY);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_COB
      USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_COB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_HOSPITAL
      USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/CLAIM_HOSPITAL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
  CREATE TABLE IF NOT EXISTS CLAIM_HOSPITAL USING column OPTIONS(partition_by 'PRSN_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,PRSN_ID,CLM_ID,CLM_HOSP_ID ' ) AS (SELECT * FROM staging_CLAIM_HOSPITAL);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/UM_INPATIENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS UM_INPATIENT USING column OPTIONS(partition_by 'UM_RVW_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,UM_RVW_ID,UM_INPT_ID ' ) AS (SELECT * FROM staging_UM_INPATIENT);
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_SERVICE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationCol/UM_SERVICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS UM_SERVICE USING column OPTIONS(partition_by 'UM_RVW_ID',redundancy '1',buckets '32',key_columns 'CLIENT_ID,UM_RVW_ID,UM_SERV_ID ' ) AS (SELECT * FROM staging_UM_SERVICE);

DROP TABLE IF EXISTS INQUIRY;
DROP TABLE IF EXISTS staging_INQUIRY;
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INQUIRY
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/INQUIRY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
USING row OPTIONS(partition_by 'INQ_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/ORGANIZATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
USING row OPTIONS(partition_by 'ORG_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_REVIEW
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_REVIEW.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS UM_REVIEW(UM_RVW_ID BIGINT   NOT NULL,
                         ...
                         USING row OPTIONS(partition_by 'UM_RVW_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/INVOICE_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  INVOICE_DETAIL(
 ...
 USING row OPTIONS(partition_by 'INV_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_GROUP_NAME
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BENEFIT_GROUP_NAME.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_GROUPS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BENEFIT_GROUPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_RECONCILIATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BILLING_RECONCILIATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BILLING_RECONCILIATION(
 ...
 USING row OPTIONS(partition_by 'BILL_ENT_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CHECKS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/CHECKS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CHECKS(
 ...
 USING row OPTIONS(partition_by 'CLM_PAY_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLIENT_REFERENCE_DATA
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/CLIENT_REFERENCE_DATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS CLIENT_REFERENCE_DATA(
 ...
 USING row OPTIONS(partition_by 'CLIENT_REF_DTA_ID', buckets '32',redundancy '1' );
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COB_CLAIM_DIAGNOSIS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/COB_CLAIM_DIAGNOSIS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS COB_CLAIM_DIAGNOSIS(
 ...
 USING row OPTIONS(partition_by 'PRSN_ID',buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_COB_ORGANIZATION_PERSON
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/COB_ORGANIZATION_PERSON.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_DIAGNOSIS_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/DIAGNOSIS_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS DIAGNOSIS_CODE(
  ...
  PRIMARY KEY (CLIENT_ID,DIAG_CD_ID)
   ...
   USING row OPTIONS(partition_by 'DIAG_CD_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ELECTRONIC_ADDRESS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/ELECTRONIC_ADDRESS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ELECTRONIC_ADDRESS(
 ...
 USING row OPTIONS(partition_by 'CNTC_ID',buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ENTITY_BANK_ACCOUNT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/ENTITY_BANK_ACCOUNT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ETL_METADATA
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/ETL_METADATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS ETL_METADATA(
  ...
  ) USING row OPTIONS(partition_by 'COL_ORD_NUM', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/EXHIBIT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS EXHIBIT(
  ...
  ) USING row OPTIONS(partition_by 'EXHIBIT_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXPLANATION_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/EXPLANATION_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS EXPLANATION_CODE(
  ...
  ) USING row OPTIONS(partition_by 'EXPLAIN_CD_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FILE_TRANSFER_RUN
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/FILE_TRANSFER_RUN.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS FILE_TRANSFER_RUN(
  ...
  ) USING row OPTIONS(partition_by 'FL_TRANS_RUN_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FILE_TRANSFER_STAT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/FILE_TRANSFER_STAT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS FILE_TRANSFER_STAT(
  ...
  ) USING row OPTIONS(partition_by 'FL_TRANS_STAT_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GENERAL_LEDGER
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/GENERAL_LEDGER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GROUP_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/GROUP_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LEP_APPEAL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LEP_APPEAL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS LEP_APPEAL(
  PRSN_ID BIGINT NOT NULL,
  LEP_APL_ID BIGINT   NOT NULL,
  VER BIGINT NOT NULL,
  CLIENT_ID BIGINT NOT NULL,
  EXT_APL_ID VARCHAR(5) NOT NULL,
  APL_DT DATE,
  RCV_DT DATE,
  APL_DCN VARCHAR(5),
  VLD_FRM_DT date NOT NULL,
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LETTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_DISALLOW_EXPLANATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LINE_DISALLOW_EXPLANATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LINE_PROCEDURE_MODIFIER
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LINE_PROCEDURE_MODIFIER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MARX_CALENDAR
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/MARX_CALENDAR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS MARX_CALENDAR(
  ...
  ) USING row OPTIONS(partition_by 'MARX_CAL_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_NOTE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/NOTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_CONTACT_TYPE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/ORGANIZATION_CONTACT_TYPE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PAYMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PAYMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_COB
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_COB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_EVENT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_LEP_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_PROFILE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_LEP_PROFILE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ORGANIZATION_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_ORGANIZATION_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_PAYMENT_OPTIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_PAYMENT_OPTIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ROLE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_ROLE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_SUBSIDY_PROFILE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_SUBSIDY_PROFILE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_WORK_ITEM
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_WORK_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PHONE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PHONE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PLAN_MEMBERSHIPS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PLAN_MEMBERSHIPS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_POS_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/POS_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS POS_CODE(
  ...
  ) USING row OPTIONS(partition_by 'POS_CD_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PREMIUM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_REFERENCE_DATA
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/REFERENCE_DATA.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS REFERENCE_DATA(
  REF_DTA_ID BIGINT   NOT NULL,
  VER BIGINT NOT NULL,
  REF_DMN VARCHAR(5) NOT NULL,
  REF_CD VARCHAR(30),
  DESCR VARCHAR(15),
  VLD_FRM_DT date NOT NULL,
  VLD_TO_DT date,
  PRIMARY KEY (REF_DTA_ID,REF_DMN)
  ) USING row OPTIONS(partition_by 'REF_DTA_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_RETURNED_MAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/RETURNED_MAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS RETURNED_MAIL(
  ...
  ) USING row OPTIONS(partition_by 'RTRN_MAIL_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_ACTIVITY
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_ACTIVITY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_DIAGNOSIS_LINE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_DIAGNOSIS_LINE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_DIAGNOSIS_SET
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_DIAGNOSIS_SET.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_PACKAGE_RELATION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BENEFIT_PACKAGE_RELATION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BENEFIT_PACKAGE_RELATION(
  ...
  ) USING row OPTIONS(partition_by 'BENE_PKG_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY_CONTACT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BILLING_ENTITY_CONTACT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BILLING_ENTITY_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CHECK_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/CHECK_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT_GROUP
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/EXHIBIT_GROUP.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS EXHIBIT_GROUP(
  ...
  ) USING row OPTIONS(partition_by 'EXHIBIT_GRP_ID', buckets '32',redundancy '1' );
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_EXHIBIT_GROUP_EXHIBIT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/EXHIBIT_GROUP_EXHIBIT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_GENERAL_LEDGER_MAP
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/GENERAL_LEDGER_MAP.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS GENERAL_LEDGER_MAP(
  ...
  ) USING row OPTIONS(partition_by 'GL_MAP_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LEP_APPEAL_DECISION
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LEP_APPEAL_DECISION.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_DETAIL
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LETTER_DETAIL.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_JOB
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LETTER_JOB.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS LETTER_JOB(
  ...
  CLIENT_ID BIGINT NOT NULL,
  SRC_REF_ID BIGINT,
  LTR_SRC_NUM VARCHAR(5),
  QA_DT DATE,
  INBOUND_SRC_REF_ID BIGINT,
  LTR_INBOUND_SRC_NUM VARCHAR(5),
  PG_CNT INTEGER,
  VLD_FRM_DT date NOT NULL,
  VLD_TO_DT date,
  SRC_SYS_REF_ID VARCHAR(10) NOT NULL,
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_REGISTER
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LETTER_REGISTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_LETTER_WORK_ITEM
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/LETTER_WORK_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_EVENT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSON_EVENT_STATUS(
  ...
  ) USING row OPTIONS(partition_by 'PRSN_EVNT_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_EVENT_STATUS_REASON
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_EVENT_STATUS_REASON.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS PERSON_EVENT_STATUS_REASON(
  ...
  ) USING row OPTIONS(partition_by 'PRSN_EVNT_STAT_ID',buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_LEP_PROFILE_RECORD
 USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_LEP_PROFILE_RECORD.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_CATEGORY
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PREMIUM_CATEGORY.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_PART
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PREMIUM_PART.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PREMIUM_TABLE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PREMIUM_TABLE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_REVIEW
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_INPATIENT_REVIEW.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_INPATIENT_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_SERVICE_OVERRIDE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_SERVICE_OVERRIDE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BANK_ACCOUNT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BANK_ACCOUNT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS BANK_ACCOUNT(
  ...
  ) USING row OPTIONS(partition_by 'BNK_ORG_ID',buckets '32',redundancy '1' );
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UM_INPATIENT_STAY_LENGTH
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UM_INPATIENT_STAY_LENGTH.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_REVENUE_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/REVENUE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS REVENUE_CODE(
  ...
  ) USING row OPTIONS(partition_by 'REV_CD_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICE_CODE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICE_CODE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS SERVICE_CODE(
  ...
  ) USING row OPTIONS(partition_by 'SERV_CD_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_AGREEMENT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/AGREEMENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS AGREEMENT(
  ...
  ) USING row OPTIONS(partition_by 'AGREE_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_ORGANIZATION_EVENT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/ORGANIZATION_EVENT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_TX_IDCARD
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/FDI_TX_IDCARD.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS FDI_TX_IDCARD
  ...
  ORG_ID BIGINT NOT NULL,
  ORG_DESC VARCHAR(15),
  FLRQ_PREPRINT_DCN VARCHAR(5),
  FLRQ_POSTPRINT_DCN VARCHAR(5),
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_TX_LETTER
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/FDI_TX_LETTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BENEFIT_PACKAGE_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BENEFIT_PACKAGE_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_ENTITY_SCHEDULE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BILLING_ENTITY_SCHEDULE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_SCHEDULE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BILLING_SCHEDULE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  BILLING_SCHEDULE(
  ...
  ) USING row OPTIONS(partition_by 'BILL_SCHD_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_BILLING_SOURCE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/BILLING_SOURCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CHARGE_ITEM
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/CHARGE_ITEM.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_COSHARE_TRACKING
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/CLAIM_COSHARE_TRACKING.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_CLAIM_LINE_ATTRIBUTE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/CLAIM_LINE_ATTRIBUTE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
--CREATE EXTERNAL TABLE IF NOT EXISTS  staging_FDI_CORRESPONDENCE
  --  USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/FDI_CORRESPONDENCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  FDI_CORRESPONDENCE
  ...
  ) USING row OPTIONS(partition_by 'CLIENT_ID, ENTITY_ID, DCN_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/INVOICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_INVOICE_STATUS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/INVOICE_STATUS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_BALANCE_EXCEPTIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/MOOP_BALANCE_EXCEPTIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  MOOP_BALANCE_EXCEPTIONS(
  ...
  ) USING row OPTIONS(partition_by 'MEMBER_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_BALANCE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/MOOP_BALANCE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_MOOP_ACCUMULATOR
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/MOOP_ACCUMULATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
) USING row OPTIONS(partition_by 'CLIENT_ID,FAMILY_ID', buckets '32',redundancy '1' );
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PERSON_ACCUMULATOR
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PERSON_ACCUMULATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_PROCEDURE_PRICE
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/PROCEDURE_PRICE.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  PROCEDURE_PRICE(
  ...
  ) USING row OPTIONS(partition_by 'PR_CD_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_RECEIPT
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/RECEIPT.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_PLAN_CODE_CONFIG
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_PLAN_CODE_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_KEY_GENERATOR
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_KEY_GENERATOR.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  SERVICES_KEY_GENERATOR
  ...
  VER   BIGINT  NOT NULL,
  CLIENT_ID BIGINT  NOT NULL,
  KEY_GEN_FORMAT   VARCHAR(5)    NULL,
  APPLICATION_CODE VARCHAR(5)    NULL,
  PROCESS_CODE     VARCHAR(5)    NULL,
  CREATE_date date NULL,
  UPDATED_date  date NULL,
  USER_NAME     VARCHAR(15)    NULL,
  VLD_FRM_DT date	NULL,
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_GROUP_CODE_CONFIG
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_GROUP_CODE_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_DNIS_CONFIG
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_DNIS_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_DENIAL_REASON_CONFIG
      USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_DENIAL_REASON_CONFIG.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_CLIENT_MASTER
      USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_CLIENT_MASTER.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_SUBJECT_CATEGORY_TRANSLATIONS
     USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_SUBJECT_CATEGORY_TRANSLATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_PTMR_VARIABLE_TRANSLATIONS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_PTMR_VARIABLE_TRANSLATIONS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  SERVICES_PTMR_VARIABLE_TRANSLATIONS
  (
  VARIABLE_ID INT NOT NULL,
  VER  BIGINT NOT NULL,
  CLIENT_ID BIGINT NOT NULL,
  VARIABLE_NAME    VARCHAR(5)    NULL,
  VARIABLE_TYPE    VARCHAR(5)    NULL,
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_SERVICES_ACCOUNTING_CODES
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/SERVICES_ACCOUNTING_CODES.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_UNAPPLIED_CASH
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/UNAPPLIED_CASH.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  UNAPPLIED_CASH(
  ...
  ) USING row OPTIONS(partition_by 'UNAPP_CSH_ID', buckets '32',redundancy '1');
...
CREATE EXTERNAL TABLE IF NOT EXISTS  staging_WORK_GENERATED_KEYS
    USING com.databricks.spark.csv OPTIONS (path ':dataFilesLocationRow/WORK_GENERATED_KEYS.dat', header 'true', inferSchema 'true', nullValue 'NULL', maxCharsPerColumn '4096');
CREATE TABLE IF NOT EXISTS  WORK_GENERATED_KEYS(
  ...
  ) USING row OPTIONS(partition_by 'GEN_KEY_ID', buckets '32',redundancy '1');
