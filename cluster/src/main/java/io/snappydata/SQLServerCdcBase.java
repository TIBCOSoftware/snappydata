...
public abstract class SQLServerCdcBase extends JavaCdcStreamingBase {
  ...
  private static Map<String, String> extraConfigProps(Map<String, String> extraProps) {
    ...
    extraProps.putIfAbsent("offsetColumn","__$start_lsn");
    extraProps.putIfAbsent("offsetToStrFunc","master.dbo.fn_varbintohexstr");
    extraProps.putIfAbsent("offsetIncFunc", "master.dbo.fn_cdc_increment_lsn");
    extraProps.putIfAbsent("strToOffsetFunc","master.dbo.fn_cdc_hexstrtobin");
    extraProps.putIfAbsent("getNextOffset",
