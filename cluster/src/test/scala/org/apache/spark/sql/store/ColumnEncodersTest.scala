 ...
 */
class ColumnEncodersTest extends SnappyFunSuite {
  ...
  test("Type encoders/decoders test") {
    ...
    session.conf.set(Property.ColumnBatchSize.name, "8192")
    ...
    for (_ <- 1 to 5) {
      val numItems = rnd.nextInt(32000) + 32760
...
case class AllTypes(index: Int, t1: java.lang.Boolean, t2: java.lang.Byte,
  ...
  override def equals(obj: Any): Boolean = obj match {
    case a: AllTypes if ColumnEncodersTest.hasNulls =>
