...
You can run the example programs as jobs in the SnappyData cluster using either snappy-job.sh script ([Embedded mode](https://tibcosoftware.github.io/snappydata/1.3.1/affinity_modes/embedded_mode/)) or spark-submit script ([Smart Connector mode](https://tibcosoftware.github.io/snappydata/1.3.1/affinity_modes/connector_mode/)).
